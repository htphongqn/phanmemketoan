...
{
    public class KTNHOMHHRepo
    {
        dbVstoreAppDataContext db = new dbVstoreAppDataContext();

        public virtual KT_NHOMHH GetById(int id)
        {
            try
            {
                return this.db.KT_NHOMHHs.Single(u => u.ID == id);
            }
            catch
            {
                return null;
        ...
        public virtual void Remove(int id)
        {
            try
            {
                KT_NHOMHH user = this.GetById(id);
                this.Remove(user);
            }
            catch (Exception e)
            {
